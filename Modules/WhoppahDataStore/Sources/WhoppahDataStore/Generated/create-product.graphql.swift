...
public extension GraphQL {
  final class CreateProductMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      mutation createProduct($input: ProductInput!, $playlist: PlaylistType = HLS) {
    ...
    public init(input: ProductInput, playlist: PlaylistType? = nil) {
      self.input = input
      self.playlist = playlist
    }

    public var variables: GraphQLMap? {
      return ["input": input, "playlist": playlist]
    }
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct CreateProduct: GraphQLSelectionSet {
        ...
        public struct Auction: GraphQLSelectionSet {
          ...
          public init(id: UUID, state: AuctionState, startDate: DateTime? = nil, expiryDate: DateTime? = nil, endDate: DateTime? = nil, buyNowPrice: BuyNowPrice? = nil, minimumBid: MinimumBid? = nil, allowBid: Bool, allowBuyNow: Bool, bidCount: Int, highestBid: HighestBid? = nil) {
