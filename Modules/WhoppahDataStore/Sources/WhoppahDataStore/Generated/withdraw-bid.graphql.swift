...
public extension GraphQL {
  final class WithdrawBidMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      mutation withdrawBid($id: UUID!) {
        withdrawBid(id: $id) {
          __typename
          id
          state
    ...
    public let operationName: String = "withdrawBid"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("withdrawBid", arguments: ["id": GraphQLVariable("id")], type: .nonNull(.object(WithdrawBid.selections))),
        ]
      }
      ...
      public init(withdrawBid: WithdrawBid) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "withdrawBid": withdrawBid.resultMap])
      }

      public var withdrawBid: WithdrawBid {
        get {
          return WithdrawBid(unsafeResultMap: resultMap["withdrawBid"]! as! ResultMap)
        }
        set {
          resultMap.updateValue(newValue.resultMap, forKey: "withdrawBid")
        }
      }

      public struct WithdrawBid: GraphQLSelectionSet {
