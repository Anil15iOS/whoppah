...
public extension GraphQL {
  final class RejectBidMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      mutation rejectBid($id: UUID!) {
        rejectBid(id: $id) {
          __typename
          id
          state
    ...
    public let operationName: String = "rejectBid"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("rejectBid", arguments: ["id": GraphQLVariable("id")], type: .nonNull(.object(RejectBid.selections))),
        ]
      }
      ...
      public init(rejectBid: RejectBid) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "rejectBid": rejectBid.resultMap])
      }

      public var rejectBid: RejectBid {
        get {
          return RejectBid(unsafeResultMap: resultMap["rejectBid"]! as! ResultMap)
        }
        set {
          resultMap.updateValue(newValue.resultMap, forKey: "rejectBid")
        }
      }

      public struct RejectBid: GraphQLSelectionSet {
