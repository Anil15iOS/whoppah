...
public extension GraphQL {
  final class CreatePaymentMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      mutation createPayment($id: UUID!, $values: PaymentInput!) {
        createPayment(id: $id, values: $values) {
          __typename
          id
          bid {
            __typename
    ...
    public let operationName: String = "createPayment"

    public var id: UUID
    public var values: PaymentInput

    public init(id: UUID, values: PaymentInput) {
      self.id = id
      self.values = values
    }
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("createPayment", arguments: ["id": GraphQLVariable("id"), "values": GraphQLVariable("values")], type: .nonNull(.object(CreatePayment.selections))),
        ]
      }
      ...
      public init(createPayment: CreatePayment) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "createPayment": createPayment.resultMap])
      }

      public var createPayment: CreatePayment {
        get {
          return CreatePayment(unsafeResultMap: resultMap["createPayment"]! as! ResultMap)
        }
        set {
