...
public extension GraphQL {
  final class CreateAddressMutation: GraphQLMutation {
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("createAddress", arguments: ["input": GraphQLVariable("input")], type: .nonNull(.object(CreateAddress.selections))),
        ]
      }
      ...
      public init(createAddress: CreateAddress) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "createAddress": createAddress.resultMap])
      }

      public var createAddress: CreateAddress {
        get {
          return CreateAddress(unsafeResultMap: resultMap["createAddress"]! as! ResultMap)
        }
        set {
