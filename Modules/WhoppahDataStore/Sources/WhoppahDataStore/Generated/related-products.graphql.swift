...
public extension GraphQL {
  final class GetRelatedProductsQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      query getRelatedProducts($product_id: String!) {
        relatedProducts(product: $product_id) {
          __typename
          id
          title
          slug
    ...
    public let operationName: String = "getRelatedProducts"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("relatedProducts", arguments: ["product": GraphQLVariable("product_id")], type: .nonNull(.list(.nonNull(.object(RelatedProduct.selections))))),
        ]
      }
      ...
      public init(relatedProducts: [RelatedProduct]) {
        self.init(unsafeResultMap: ["__typename": "Query", "relatedProducts": relatedProducts.map { (value: RelatedProduct) -> ResultMap in value.resultMap }])
      }

      public var relatedProducts: [RelatedProduct] {
        get {
          return (resultMap["relatedProducts"] as! [ResultMap]).map { (value: ResultMap) -> RelatedProduct in RelatedProduct(unsafeResultMap: value) }
        }
        set {
          resultMap.updateValue(newValue.map { (value: RelatedProduct) -> ResultMap in value.resultMap }, forKey: "relatedProducts")
        }
      }

      public struct RelatedProduct: GraphQLSelectionSet {
        ...
        public struct Merchant: GraphQLSelectionSet {
          ...
          public init(id: UUID, type: MerchantType, name: String, businessName: String? = nil, expertSeller: Bool? = nil, created: DateTime, complianceLevel: Int? = nil, avatar: Avatar? = nil) {
            self.init(unsafeResultMap: ["__typename": "Merchant", "id": id, "type": type, "name": name, "business_name": businessName, "expert_seller": expertSeller, "created": created, "compliance_level": complianceLevel, "avatar": avatar.flatMap { (value: Avatar) -> ResultMap in value.resultMap }])
          }
        ...
        public struct Auction: GraphQLSelectionSet {
          ...
          public init(id: UUID, state: AuctionState, startDate: DateTime? = nil, expiryDate: DateTime? = nil, endDate: DateTime? = nil, buyNowPrice: BuyNowPrice? = nil, minimumBid: MinimumBid? = nil, allowBid: Bool, allowBuyNow: Bool, bidCount: Int, highestBid: HighestBid? = nil, bids: [Bid]) {
