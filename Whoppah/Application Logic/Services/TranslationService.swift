...
//  Whoppah
//
//  Created by Levon Hovsepyan on 14.06.21.
...
public class TranslationService {
    ...
    public init() {
#if TESTING || DEBUG
        start(with: "AIzaSyBz-uJ3DhzMWGuu3iFscgiQjH66sEBSpdM")
#else
        start(with: "AIzaSyBz-uJ3DhzMWGuu3iFscgiQjH66sEBSpdM")
#endif
    }
    ...
    */
    ...
    /**
        ...
        - Parameters:
            - target: The target language code for the results. If specified, then the language names are returned in the name field of the response, localized in the target language.
            ...
            - model: The translation model of the supported languages. Can be either base to return languages supported by the Phrase-Based Machine Translation (PBMT) model,
                    or nmt to return languages supported by the Neural Machine Translation (NMT) model. If omitted, then all supported languages are returned. Languages
                    supported by the NMT model can only be translated to or from English (en).
