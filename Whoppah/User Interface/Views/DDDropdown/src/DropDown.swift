...
public typealias CellConfigurationClosure = (Index, String, DDDropDownCell) -> Void
...
/// A MaterialOld Design drop down in replacement for `UIPickerView`.
public final class DropDown: UIView {
    ...
    fileprivate var templateCell: DDDropDownCell!
     ...
     */
    @objc public dynamic var shadowColor = DPDConstant.UI.Shadow.ColorOld {
     ...
     */
    public var cellNib = UINib(nibName: "DDDropDownCell", bundle: Bundle(for: DDDropDownCell.self)) {
        didSet {
...
extension DropDown {
    ...
    fileprivate func fittingWidth() -> CGFloat {
        if templateCell == nil {
            templateCell = (cellNib.instantiate(withOwner: nil, options: nil)[0] as! DDDropDownCell)
        }
...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: DPDConstant.ReusableIdentifier.DropDownCell, for: indexPath) as! DDDropDownCell
    ...
    fileprivate func configureCell(_ cell: DDDropDownCell, at index: Int) {
